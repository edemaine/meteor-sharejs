...
// We use the current sharejs document as a proxy for the current document.
  ...
  window.sharejs.extendDoc('attach_cm', function(editor, keepEditorContents) {
    var check, editorListener, onDelete, onInsert, sharedoc, suppress, undoDepth;
    ...
    this.on('insert', onInsert = function(pos, text) {
    ...
    this.on('delete', onDelete = function(pos, text) {
      var from, to;
      suppress = true;
